...
const terms = () => {
  return (
    <div>
      <h1>TERMS OF SERVICE</h1> <h2> TLDR:</h2> We won't sell your data. :) We
      do use Google Analytics. And if you want to read the legal jargon... good
      luck.<h2> OVERVIEW </h2>This website is operated by Accelerant Education
      LLC. Throughout the site, the terms “we”, “us” and “our” refer to
      Accelerant Education LLC. Accelerant Education LLC offers this website,
      ...
      services to you. <h3>SECTION 1 </h3> - ONLINE STORE TERMS By agreeing to
      ...
      your Services. <h3> SECTION 2 - GENERAL CONDITIONS</h3> We reserve the
      ...
      <h3> SECTION 5 - PRODUCTS OR SERVICES </h3>(if applicable) Certain
      ...
      please review our Returns Policy. <h3> SECTION 7 - OPTIONAL TOOLS</h3> We
      ...
      these Terms of Service. <h3>SECTION 8 - THIRD-PARTY LINKS </h3>Certain
      content, products and services available via our Service may include
      materials from third-parties. Third-party links on this site may direct
      ...
      <h3>SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h3> If, at
      our request, you send certain specific submissions (for example contest
      ...
      our Privacy Policy.
      <h3> SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h3> Occasionally
      ...
      or on any related website has been modified or updated. SECTION 12 -
      ...
      durability, title, and non-infringement. In no case shall Accelerant
      Education LLC, our directors, officers, employees, affiliates, agents,
      ...
      hold harmless Accelerant Education LLC and our parent, subsidiaries,
      ...
      other remaining provisions. <h3>SECTION 16 - TERMINATION</h3> The
      ...
      Services (or any part thereof). <h3>SECTION 17 - ENTIRE AGREEMENT </h3>The
      ...
      Terms of Service and any policies or operating rules posted by us on this
      ...
      against the drafting party. <h3> SECTION 18 - GOVERNING LAW</h3> These
      ...
      7117 FLORIDA BLVD, Baton Rouge, LA, 70806, United States.
      <h3> SECTION 19 - CHANGES TO TERMS OF SERVICE</h3> You can review the most
      ...
      acceptance of those changes. <h3> SECTION 20 - CONTACT INFORMATION</h3>
      Questions about the Terms of Service should be sent to us at
      joshua@acceleranteducation.com.
    </div>
  );
};
