...
const privacy = () => {
  return (
    <div>
      ...
      credit card numbers [[INSERT ANY OTHER PAYMENT TYPES ACCEPTED]]), email
      ...
      [[INSERT OTHER USES OF ORDER INFORMATION]] We use the Device Information
      ...
      marketing and advertising campaigns). [[INSERT OTHER USES OF DEVICE
      INFORMATION, INCLUDING: ADVERTISING/RETARGETING]] SHARING YOUR PERSONAL
      INFORMATION We share your Personal Information with third parties to help
      us use your Personal Information, as described above. We also use Google
      ...
      As described above, we may use your Personal Information to provide you
      ...
      practices when we see a Do Not Track signal from your browser. [[INCLUDE
      IF LOCATED IN OR IF STORE HAS CUSTOMERS IN EUROPE]] YOUR RIGHTS If you are
      a European resident, you have the right to access personal information we
      ...
      contact us through the contact information below. Additionally, if you are
      a European resident we note that we are processing your information in
      order to fulfill contracts we might have with you (for example if you make
      an order through the Site), or otherwise to pursue our legitimate business
      ...
      States.
      <h2>DATA RETENTION </h2>When you place an order through the Site, we will
      maintain your Order Information for our records unless and until you ask
      us to delete this information.
      <h2>MINORS </h2>The Site is not intended for individuals under the age of
      18. CHANGES We may update this privacy policy from time to time in order
      to reflect, for example, changes to our practices or for other
      operational, legal or regulatory reasons. CONTACT US For more information
      about our privacy practices, if you have questions, or if you would like
      to make a complaint, please contact us by e-mail at
      joshua@acceleranteducation.com or by mail using the details provided
      below: 7117 FLORIDA BLVD, Baton Rouge, LA, 70806, United States
    </div>
  );
};
